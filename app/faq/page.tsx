...
export const metadata: Metadata = {
  title: "자주 묻는 질문 FAQ | 몽키페이",
  description: "몽키페이 소액결제 현금화 서비스에 대한 자주 묻는 질문과 답변. 안전성, 수수료, 입금 시간, 이용 방법 등 모든 궁금증을 해결하세요.",
  openGraph: {
    title: "자주 묻는 질문 FAQ | 몽키페이",
    description: "몽키페이 소액결제 현금화 서비스에 대한 자주 묻는 질문과 답변을 확인하세요.",
  },
};
...
const faqs = [
  ...
  { 
    q: "개인정보는 어떻게 보호되나요?", 
    a: "몽키페이은 개인정보보호법을 준수하며, 거래 목적 외로 개인정보를 사용하지 않습니다. 제공해주신 정보는 거래 완료 후 안전하게 파기되며, 암호화된 채널을 통해 전송됩니다. 자세한 내용은 개인정보처리방침을 참고해주세요." 
  },
];
        ...
        <div className="container-main max-w-4xl">
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-700">
              몽키페이 소액결제 현금화 서비스에 대한 자주 묻는 질문과 답변입니다.
            </p>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details key={index} className="card-brutal p-6 cursor-pointer">
          ...
          <div className="mt-16 card-brutal-dark p-8 text-center">
            <h2 className="text-3xl font-black text-white mb-6 uppercase">더 궁금한 점이 있으신가요?</h2>
            <p className="text-white/90 mb-8 text-lg">24시간 상담 가능한 고객센터로 문의해주세요</p>
